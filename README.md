# Super Mario OG (VS Code Edition) 🍄👾
...
![Super Mario OG Demonstration](media/Extensiondemo.gif)

## 🌟 Key Features
- **Original NES Experience:** Real JSNES emulation with original physics and sprites.
...
- **Custom Key Mapping:** Optimized for platforming with WASD and Arrow keys.
...
2. Click the **Super Mario OG icon** in the top-right navigation bar OR press `Ctrl+Shift+P` and type `Play Super Mario OG`.
...
| **Crouch/Down** | `S` | `Down` Arrow |
| **Jump** (Button A) | `W` | `Up` Arrow |
| **Fire / Run** (Button B) | `E` | - |
| **Start** | `Enter` | - |
| **Select** | `Shift` | - |
